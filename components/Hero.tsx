    ...
    >
      ...
      >
        ...
        <div ref={bgRef} className="absolute inset-0 overflow-hidden">
          <Image
            src="/agro-app-hero-5.png"
            alt="Global healthcare payments"
            fill
            priority
            quality={100}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto pt-4 gap-4">
          ...
          >
            Devoliviendo el poder a los agricultores
          </h1>
          ...
          <p
            ...
            style={{ willChange: 'transform, opacity, filter' }} // Optimize for animation
          >
            Agronegocios con más oportunidades, más rentabilidad y más impacto.
          </p>
        </div>
      </div>
    </section>
