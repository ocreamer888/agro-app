    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto pt-4 gap-4">
          ...
          >
            Precios justos y transparentes, sin intermediarios
          </h1>
          <p 
            ref={subtitleRef}
          ...
          >
            Comprando directamente con los agricultores evitas sobreprecios y colaboras con la agricultura sostenible.
          </p>
        </div>
      </div>
    </section>
