  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative flex flex-col items-around justify-around h-[25vh] z-10 text-center max-w-4xl mx-auto pt-4 gap-4">
          <h1
            ref={titleRef}
          ...
          >
            Formá parte de la revolución de la agricultura sostenible en Costa Rica
          </h1>
          <div
            ref={subtitleRef}
          ...
          >
          <Link href="https://chat.whatsapp.com/JoIvJRuLMgq9iFU2whad6z?mode=wwt" className="text-white rounded-full px-4 py-2 green-gradient font-medium">Unite a la comunidad</Link>
          </div>
